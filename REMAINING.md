...
|---|---|
| záznamů celkem | **2483** |
| z toho granty / foundation_mission | 2457 / 26 |
| poskytovatelů | **125** |
| status grantů | ~382 open · ~37 announced · ~1300 closed · ~738 unknown (počítá se klientsky k dnešku) |
| typy poskytovatelů | samosprava_kraj 844 · samosprava_obec 798 · ministerstvo 558 · nadacni_fond 63 · nadace 57 · statni_fond 51 · statni_agentura 44 · firemni_nadace 42 · zahranicni_fond 26 |
...
| 5. EU operační programy (řízené z ČR) | ~35 % | **OPŽP (107) + OP ST (98) hotovo**; chybí OP TAK/OPZ+/OP JAK/OPD/NPO/PRV/Interreg (P3) |
