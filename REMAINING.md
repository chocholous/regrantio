...
|---|---|
| záznamů celkem | **2256** |
| z toho granty / foundation_mission | 2231 / 25 |
| poskytovatelů | **121** |
| status grantů | ~342 open · ~39 announced · ~1064 closed · ~724 unknown (počítá se klientsky k dnešku) |
| typy poskytovatelů | samosprava_kraj 844 · samosprava_obec 798 · ministerstvo 353 · nadacni_fond 63 · nadace 56 · statni_fond 51 · firemni_nadace 42 · zahranicni_fond 26 · statni_agentura 23 |
...
| 4. Státní agentury | ~55 % | GA ČR + **TAČR hotovo**; chybí NSA (sport), SZIF, Úřad vlády (P2b) |
...
- [ ] **NSA — Národní sportovní agentura** (`agenturasport.cz`) — **CHYBÍ, velký objem**: investiční i
      neinvestiční dotace na sport (Můj klub, Provoz a údržba, Movité investice, Standardizovaná infrastruktura). **← DALŠÍ (P2b).**
