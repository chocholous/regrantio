...
|---|---|
| záznamů celkem | **2385** |
| z toho granty / foundation_mission | 2359 / 26 |
| poskytovatelů | **124** |
| status grantů | ~369 open · ~37 announced · ~1215 closed · ~738 unknown (počítá se klientsky k dnešku) |
| typy poskytovatelů | samosprava_kraj 844 · samosprava_obec 798 · ministerstvo 460 · nadacni_fond 63 · nadace 57 · statni_fond 51 · statni_agentura 44 · firemni_nadace 42 · zahranicni_fond 26 |
...
| 5. EU operační programy (řízené z ČR) | ~25 % | **OPŽP hotovo (107)**; chybí OP TAK/OPZ+/OP JAK/OPD/NPO/PRV/Interreg (P3) |
